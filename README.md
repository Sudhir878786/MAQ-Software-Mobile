...
> **Due to safety reasons, the source code for this app is kept private.** However, if you'd like to contribute or propose changes, you can create a Pull Request (PR) with your changes, and i'll review it.
